            ...
            switch (option) {
                ...
                case 3:
                    ...
                    if (x >= 0 && x < products.size()) {
                        ...
                        products.get(x).addProduct(addQuantity);
                        System.out.println("Quantidade em estoque após adicionar " + addQuantity +
                                " produtos: " + products.get(x).getQuantity());
                    } else {
                ...
                case 4:
                    System.out.print("Qual é o índice do produto que deseja remover do estoque? ");
                    int indexRemove = scanner.nextInt();
                    int y = indexRemove - 1;
                    if (y >= 0 && y < products.size()) {
                        System.out.print("Quantos produtos deseja remover do estoque? ");
                        int removeQuantity = scanner.nextInt();
                        products.get(y).removeProduct(removeQuantity);
                        System.out.println("Quantidade em estoque após remover " + removeQuantity +
                                " produtos: " + products.get(y).getQuantity());
                    } else {
                        System.out.println("Índice inválido.");
                    }
                    break;
                ...
                case 5:
                    ...
                    if (z >= 0 && z < products.size()) {
                        System.out.print("Percentual de aumento ou desconto (%): ");
                        double percent = scanner.nextDouble();
                        products.get(z).ajustPrice(percent);
                        ;
